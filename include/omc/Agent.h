...
public:
    ...
    /**
     * Initialize all declarative attributes, such as identity attributes and derived attributes.
     * The function definition is specific to each kind of agent and is generated by the openM++
     * compiler.
     */
    virtual void om_initialize_declarative_attributes() = 0;
    ...
    /**
     * Move all agents from zombie lists to corresponding available list The function definition is
     * generated by the openM++ compiler.
     */
    ...
    void om_Start_begin()
    {
        ...
        om_set_entity_id();
        om_set_start_time();
        om_initialize_declarative_attributes();
    }
