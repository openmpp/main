...
bool Symbol::option_fp_exceptions_warning = true;
...
size_t Symbol::option_screened1_extremas_size = 0;
size_t Symbol::option_screened2_extremas_size = 0;
size_t Symbol::option_screened3_extremas_size = 0;
size_t Symbol::option_screened4_extremas_size = 0;
...
void Symbol::do_options()
{
    ...
    {
        string key = "fp_exceptions_warning";
        auto iter = options.find(key);
        if (iter != options.end()) {
            auto& opt_pair = iter->second; // opt_pair is option value, option location
            string& value = opt_pair.first;
            if (value == "on") {
                option_fp_exceptions_warning = true;
            }
            else if (value == "off") {
                option_fp_exceptions_warning = false;
            }
            // remove processed option
            options.erase(iter);
        }
    ...
    {
        string key = "screened1_extremas_size";
        auto iter = options.find(key);
        if (iter != options.end()) {
            auto& opt_pair = iter->second; // opt_pair is option value, option location
            string& value = opt_pair.first;
            ...
            if (i_value < 0) {
                ...
                option_screened1_extremas_size = (size_t) i_value;
            }
            // remove processed option
            options.erase(iter);
        }
    ...
    {
        string key = "screened2_extremas_size";
        auto iter = options.find(key);
        if (iter != options.end()) {
            auto& opt_pair = iter->second; // opt_pair is option value, option location
            string& value = opt_pair.first;
            ...
            if (i_value < 0) {
                ...
                option_screened2_extremas_size = (size_t)i_value;
            }
            // remove processed option
            options.erase(iter);
        }
    ...
    {
        string key = "screened3_extremas_size";
        auto iter = options.find(key);
        if (iter != options.end()) {
            auto& opt_pair = iter->second; // opt_pair is option value, option location
            string& value = opt_pair.first;
            ...
            if (i_value < 0) {
                ...
                option_screened3_extremas_size = (size_t)i_value;
            }
            // remove processed option
            options.erase(iter);
        }
    ...
    {
        string key = "screened4_extremas_size";
        auto iter = options.find(key);
        if (iter != options.end()) {
            auto& opt_pair = iter->second; // opt_pair is option value, option location
            string& value = opt_pair.first;
            ...
            if (i_value < 0) {
                ...
                option_screened4_extremas_size = (size_t)i_value;
            }
            // remove processed option
            options.erase(iter);
        }
