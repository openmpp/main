...
void CodeGen::do_types()
{
    ...
    {
        // The vector keywords below aligns with table_statistic in parser.y[~2843] (with the addition of TK_unit).
...
void CodeGen::do_RunOnce()
{
    ...
    if (is_case_based && !Symbol::option_allow_unlimited_subs) {
        ...
        c += "int subs_in_run = i_runBase->totalSubCount();";
