...
void CodeGen::do_agents()
{
    for ( auto agent : Symbol::pp_all_agents ) {
        ...
        h += "void initialize_tables(); // generated by openM++ compiler";
        h += "void initialize_events(); // generated by openM++ compiler";
        h += "void finalize_tables(); // generated by openM++ compiler";
        h += "void finalize_events(); // generated by openM++ compiler";
        ...
        c += "void " + agent->name + "::initialize_tables()";
        c += "{";
        for (auto table : agent->pp_agent_tables) {
        ...
        c += "void " + agent->name + "::finalize_tables()";
        c += "{";
        for (auto table : agent->pp_agent_tables) {
	    ...
	    c += "";
        c += "// Initialize events";
        c += "void " + agent->name + "::initialize_events()";
        c += "{";
        for ( auto event : agent->pp_agent_events ) {
	    ...
	    c += "";
        c += "// Finalize events";
        c += "void " + agent->name + "::finalize_events()";
        c += "{";
        for ( auto event : agent->pp_agent_events ) {
