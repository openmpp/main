...
void CodeGen::do_preamble()
{
    ...
    t += doxygen(
                "@file   om_types.h",
                "Types for model '" + model_symbol->name + "' version=" + version_symbol->formatted_value(),
                " (generated by openM++ compiler)."
                );
    t += "" ;
	t += "#pragma once";
	t += "";
    ...
    h += doxygen(
                "@file   om_agents.h",
                "Declarations for model '" + model_symbol->name + "' version=" + version_symbol->formatted_value(),
                " (generated by openM++ compiler)."
                );
    h += "" ;
	h += "#pragma once";
    ...
    c += doxygen(
                "@file   om_agents.cpp",
                "Definitions for model '" + model_symbol->name + "' version=" + version_symbol->formatted_value(),
                " (generated by openM++ compiler)."
                );
	c += "";
    ...
    // Get definition code associated with the model symbol (name)
