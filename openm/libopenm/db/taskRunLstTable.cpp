...
namespace openm
{
    ...
    public:
        ...
        const type_info ** columnTypes(void) const { return typeTaskRunLstRow; }
...
ITaskRunLstTable::~ITaskRunLstTable(void) throw() { }

// Table never unloaded
TaskRunLstTable::~TaskRunLstTable(void) throw() { }
