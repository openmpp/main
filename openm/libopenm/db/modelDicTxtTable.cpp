...
namespace openm
{
    ...
    public:
        ...
        const type_info ** columnTypes(void) const { return typeModelDicTxtRow; }
...
IModelDicTxtTable::~IModelDicTxtTable(void) throw() { }
...
// Table never unloaded
ModelDicTxtTable::~ModelDicTxtTable(void) throw() { }
