...
my $R_exe = 'C:\Program Files\R\R-3.2.3\bin\R.exe';
...
for my $utility ('ompp_export_excel', 'ompp_export_csv', 'modgen_export_csv', 'ompp_create_scex', 'patch_modgen11_outputs', 'patch_modgen12_outputs') {
	my $input = "${utility}.pl";
