...
DROP TABLE run_entity;
DROP TABLE entity_gen_attr;
DROP TABLE entity_gen;
DROP TABLE run_progress;
DROP TABLE run_table;
DROP TABLE run_parameter_import;
...
DROP TABLE entity_group_pc;
DROP TABLE entity_group_txt;
DROP TABLE entity_group_lst;
DROP TABLE group_pc;
DROP TABLE group_txt;
DROP TABLE group_lst;
DROP TABLE entity_attr_txt;
DROP TABLE entity_attr;
DROP TABLE entity_dic_txt;
DROP TABLE model_entity_dic;
DROP TABLE entity_dic;
...
DROP TABLE model_table_dic;
DROP TABLE table_dic;
DROP TABLE parameter_dims_txt;
DROP TABLE parameter_dims;
DROP TABLE parameter_dic_txt;
DROP TABLE model_parameter_import;
DROP TABLE model_parameter_dic;
DROP TABLE parameter_dic;
DROP TABLE type_enum_txt;
