...
//
// "modelOne" model dimensions size
...
void readAllParameters(IDbExec * i_dbExec, const MetaHolder * i_metaStore, int i_runId)
{
    ...
    readModelParameter(i_dbExec, i_metaStore, i_runId, "StartingSeed", typeid(int), 1, &startSeed);
    readModelParameter(i_dbExec, i_metaStore, i_runId, "ageSex", typeid(double), ageSize * sexSize, ageSex);
    readModelParameter(i_dbExec, i_metaStore, i_runId, "salaryAge", typeid(int), salarySize * ageSize, salaryAge);
    readModelParameter(i_dbExec, i_metaStore, i_runId, "salaryFull", typeid(int), salarySize, salaryFull);
}
...
)
{
    ...
    try {
        ...
        reader->readParameter(i_dbExec, i_type, i_size, io_valueArr);
    }
    catch (exception & ex) {
